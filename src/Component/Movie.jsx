...
const Movie = ({ movie }) => {
    ...
    return (
        <div className="bg-amber-50 rounded-lg shadow-md flex-col justify-center items-center overflow-hidden ">
           ...
           <Link to='allmovies'>
           <button  className="relative w-full inline-flex items-center justify-start px-6 py-3 overflow-hidden font-medium transition-all bg-white rounded hover:bg-white group">
