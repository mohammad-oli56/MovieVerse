...
const Navbar = () => {
    ...
    return (
        <>
            ...
            <div className="navbar shadow-sm justify-between   mx-auto  md:px-12 lg:px-16 bg-[linear-gradient(220deg,_rgba(197,20,20,0)_30%,_rgba(68,51,204,0.7)_67%,_rgba(254,2,2,1))]">
